...
<body>
  ...
  <header >
    ...
    <div>
        <a href="" class="a" style="color: white; font-size: 15px;" >Cerrar Sesión</a>
    ...
    <div >
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ftl-vertical-tab-container">
              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ftl-vertical-tab-menu">
                ...
                <div class="list-group">
                  ...
                  <a href="#" class="list-group-item active text-center">
                    <h4 class="glyphicon glyphicon-book"></h4><br/>Listado de Pacientes
                  </a>
                  <a href="#" class="list-group-item text-center">
              ...
              <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 ftl-vertical-tab">
                        ...
                        <div class="container mt-3 mb-3 my_text">
                            <div style="text-align: center; width: auto;">
                              <form action="">
                                ...
                                <br>
                                <input type="number" disabled name="hora" id="hora" required>
                                <br>
                                <br>
                                <div>
                                <button type="submit" class="btn btn-dark" style="font-size: 13px; width: 200px" role="button">Agendar Cita</button>
                               </div>
                              </form>
                        </div>
                  ...
                  <div class="ftl-vertical-tab-content">
                      <center>
                        <h2 class="border border-3 text-center" style="margin-top: 0;color:#253237">Registrar Historia Clinica</h2>
                        <div class="container my_text">
                          
                           <div style="text-align: center;font-size: 18px;">
                            <label for="">Número de identificación</label>
                            <br>
                            <input type="number" name="idpaciente" id="identificacion">
                            <button class="btn btn-dark" style="color: white;" role="button">Ver</button>
                          </div>
                         <br>
