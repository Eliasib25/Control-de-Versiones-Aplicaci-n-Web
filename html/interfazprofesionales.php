              ...
              <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 ftl-vertical-tab-menu">
                ...
                <div class="list-group">
                  ...
                  <a href="#" class="list-group-item text-center">
                    <h4 class="glyphicon glyphicon-book"></h4><br/>Registrar Historia Clinica
                  </a>
                  <a href="#" class="list-group-item text-center">
                      ...
                      <center>
                        ...
                        <div class="container mt-3 mb-3 my_text">
                           ...
                           <div style="text-align: center;">
                            ...
                            <a href="../html/actualizarhistoriaclinica(profesionales).html"><button class="btn btn-dark" style="font-size: 13px; width: 200px" role="button">Ver Historia Clinica</button></a>
                           </div>
                        </div>
                      </center>
                  </div>
