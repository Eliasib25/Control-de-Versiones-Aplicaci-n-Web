...
<head>
    ...
    <title>Actualizar elementos</title>
</head>
<body>
                ...
                <div class="modal-dialog modal-login">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Editar o eliminar elementos</h4>
                            ...
                            <form action="../controladores/controladorformulario.php" method="post">
                                <div class="d-flex justify-content-center">
                                    <div class="mb-3">
                                        ...
                                        <br>
                                        <input type="text" aria-label="First name" name="tipoElemento" required 
                                        value = <?php
                                                        echo isset($_POST['tipoElemento']) ? $_POST['tipoElemento'] : '';
                                                    ?> >
                                        <br>
                                        <label for="">Nombre</label>
                                        <br>
                                        <input type="text" aria-label="First name"  name="nombre" required id="" cols="auto" rows="auto" 
                                            value = <?php
                                        ...
                                        <br>
                                        <input type="number" aria-label="First name" name="precio" required  
                                        value = <?php
                                    ...
                                    <input type="text" placeholder="Ingrese el nombre del controlador" name="controlador" value = 'elemento' hidden>
                                    </div>
                                </div>
                            </form>
                        </div>
